...
pub async fn get_update_info_for_channel(app_handle: AppHandle) -> Result<serde_json::Value, String> {
    ...
    let endpoint = if channel == "test" {
        "https://raw.githubusercontent.com/Kwensiu/Rscoop/refs/heads/test/docs/test-update.json"
    } else {
        "https://github.com/Kwensiu/Rscoop/releases/latest/download/update.json"
    };
