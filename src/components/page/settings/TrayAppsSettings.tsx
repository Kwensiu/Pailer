  ...
  return (
    ...
    >
      <Show when={!isLoading()} fallback={<div>{t('loading')}</div>}>
        <div class="space-y-3">
          <p class="text-base-content/70 mb-4 text-sm">{t('settings.trayApps.helpText')}</p>
            ...
            fallback={
              <div class="grid gap-2">
                <For each={availableApps()}>
                  {(app) => (
                    <label class="border-base-300 hover:bg-base-100 flex items-center space-x-3 rounded-lg border p-3 transition-colors">
                      <input
                        type="checkbox"
                      ...
                      <div class="flex-1">
                        ...
                        <div class="text-base-content/60 text-sm">{app.name}</div>
                      </div>
                    </label>
                  )}
                </For>
