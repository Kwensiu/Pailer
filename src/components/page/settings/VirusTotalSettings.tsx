      ...
      <div class="form-control w-full max-w-lg">
        <div class="join w-full">
          <input
            ...
            placeholder={
              isLoading()
                ? t('settings.virustotal.loading')
                : t('settings.virustotal.apiKeyPlaceholder')
            }
            class="input input-bordered join-item bg-base-100 w-full"
            value={apiKey()}
          ...
          <div class="form-control">
            <SettingsToggle
              ...
              onChange={async (checked) =>
                await setVirusTotalSettings({ autoScanOnInstall: checked })
              }
