...
I have replaced MSI packaging with NSIS, and recommend installing with setup.exe. A portable version is also provided.
...
Refer to the upstream repository documentation for already implemented features. Here I only detail the newly added features.
...
```
~~You Can adjust Rscoop log retention time and delete configuration and cache files generated by Rscoop~~  

This will **NOT** modify any data of *Scoop* itself ✅.<br>
